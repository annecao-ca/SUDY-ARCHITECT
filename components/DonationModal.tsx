    ...
    >
      ...
      >
        ...
        <div className="flex justify-center mb-4">
          <img src="https://i.postimg.cc/Y90VBy53/QR-Code.png" alt="QR Code for donation" className="w-48 h-48 rounded-md border-4 border-white dark:border-gray-700 shadow-md" />
        </div>
        ...
        <div className="p-4 bg-gray-100 dark:bg-gray-700/50 rounded-lg text-left space-y-3">
          <div>
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900 dark:text-white">{accountHolder}</p>
          </div>
          <div>
